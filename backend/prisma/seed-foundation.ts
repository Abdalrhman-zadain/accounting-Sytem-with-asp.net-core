    ...
    data: [
      {
        ...
        code: 'MENU-ASNAQ',
        name: 'الاصناق',
        description: 'مجموعة الاصناق في المنيو',
        isActive: true,
      },
      {
        id: 'GRP-MENU-HEADS-FEET',
        code: 'MENU-HEADS-FEET',
        name: 'روس و المقادم',
        description: 'مجموعة الروس والمقادم في المنيو',
        isActive: true,
      },
      {
        id: 'GRP-MENU-DISHES',
        code: 'MENU-DISHES',
        name: 'الاطباق',
        description: 'مجموعة الاطباق في المنيو',
        isActive: true,
      },
      {
        id: 'GRP-MENU-SNACKS',
        code: 'MENU-SNACKS',
        name: 'السناكات',
        description: 'مجموعة السناكات في المنيو',
        isActive: true,
      },
      {
        id: 'GRP-MENU-FATTAH',
      ...
      },
      {
        ...
        code: 'MENU-MEALS-1',
        name: 'وجبات 1',
        description: 'مجموعة وجبات 1 في المنيو',
        isActive: true,
      },
      {
        id: 'GRP-MENU-MEALS-2',
        code: 'MENU-MEALS-2',
        name: 'وجبات 2',
        description: 'مجموعة وجبات 2 في المنيو',
        isActive: true,
      },
    ],
  });
    ...
    data: [
      {
        ...
        code: 'MENU-ASNAQ',
        name: 'الاصناق',
        description: 'فئة الاصناق في المنيو',
        itemGroupId: 'GRP-MENU-ASNAQ',
        isActive: true,
      },
      {
        id: 'CAT-MENU-HEADS-FEET',
        code: 'MENU-HEADS-FEET',
        name: 'روس و المقادم',
        description: 'فئة الروس والمقادم في المنيو',
        itemGroupId: 'GRP-MENU-HEADS-FEET',
        isActive: true,
      },
      {
        id: 'CAT-MENU-DISHES',
        code: 'MENU-DISHES',
        name: 'الاطباق',
        description: 'فئة الاطباق في المنيو',
        itemGroupId: 'GRP-MENU-DISHES',
        isActive: true,
      },
      {
        id: 'CAT-MENU-SNACKS',
        code: 'MENU-SNACKS',
        name: 'السناكات',
        description: 'فئة السناكات في المنيو',
        itemGroupId: 'GRP-MENU-SNACKS',
        isActive: true,
      },
      {
        id: 'CAT-MENU-FATTAH',
      ...
      },
      {
        ...
        code: 'MENU-MEALS-1',
        name: 'وجبات 1',
        description: 'فئة وجبات 1 في المنيو',
        itemGroupId: 'GRP-MENU-MEALS-1',
        isActive: true,
      },
      {
        id: 'CAT-MENU-MEALS-2',
        code: 'MENU-MEALS-2',
        name: 'وجبات 2',
        description: 'فئة وجبات 2 في المنيو',
        itemGroupId: 'GRP-MENU-MEALS-2',
        isActive: true,
      },
    ],
  });
