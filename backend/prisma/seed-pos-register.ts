...
const POS_ITEM_GROUPS: PosGroupSeed[] = [
  { code: 'MENU-ASNAQ', name: 'الاصناق' },
  { code: 'MENU-HEADS-FEET', name: 'روس و المقادم' },
  { code: 'MENU-DISHES', name: 'الاطباق' },
  { code: 'MENU-MEALS-1', name: 'وجبات 1' },
  { code: 'MENU-MEALS-2', name: 'وجبات 2' },
...
const POS_ITEM_CATEGORIES: Array<PosGroupSeed & { itemGroupCode: string }> = [
  { code: 'MENU-ASNAQ', name: 'الاصناق', itemGroupCode: 'MENU-ASNAQ' },
  { code: 'MENU-HEADS-FEET', name: 'روس و المقادم', itemGroupCode: 'MENU-HEADS-FEET' },
  { code: 'MENU-DISHES', name: 'الاطباق', itemGroupCode: 'MENU-DISHES' },
  { code: 'MENU-MEALS-1', name: 'وجبات 1', itemGroupCode: 'MENU-MEALS-1' },
  { code: 'MENU-MEALS-2', name: 'وجبات 2', itemGroupCode: 'MENU-MEALS-2' },
...
const POS_PRODUCTS: PosProductSeed[] = [
  {
    ...
    stockMain: 100,
    stockBranch: 50,
    groupCode: 'MENU-ASNAQ',
    categoryCode: 'MENU-ASNAQ',
  ...
  },
  {
    ...
    stockMain: 100,
    stockBranch: 50,
    groupCode: 'MENU-DISHES',
    categoryCode: 'MENU-DISHES',
  ...
  },
  {
    ...
    code: 'MENU-003',
    name: 'روس',
    description: 'روس خروف - صينية مع سلطة وحمص ومخلل',
    category: 'روس و المقادم',
    salesPrice: 7,
    purchasePrice: 0,
    stockMain: 100,
    stockBranch: 50,
    groupCode: 'MENU-HEADS-FEET',
    categoryCode: 'MENU-HEADS-FEET',
  ...
  },
  {
    ...
    code: 'MENU-005',
    name: 'فوارغ',
    description: 'فوارغ - السعر للكيلو',
    category: 'الاصناق',
    salesPrice: 10,
    purchasePrice: 0,
    stockMain: 100,
  ...
  },
  {
    ...
    stockMain: 100,
    stockBranch: 50,
    groupCode: 'MENU-MEALS-1',
    categoryCode: 'MENU-MEALS-1',
  ...
  },
  {
    id: 'MENU-ADDON-003',
    code: 'MENU-ADDON-003',
    name: 'اضافة صحن فريكة',
    description: 'اضافة صحن فريكة',
    category: 'الاضافات',
    salesPrice: 0.75,
    purchasePrice: 0,
    stockMain: 0,
  ...
  },
  {
    ...
    stockMain: 100,
    stockBranch: 50,
    groupCode: 'MENU-MEALS-2',
    categoryCode: 'MENU-MEALS-2',
    unitOfMeasure: 'PCS',
  },
  {
    id: 'MENU-MEAL-002',
