...
| REQ-POS-188 | The system shall allow defining whether the payment was collected by the restaurant or by the delivery company.                                 | يجب أن يسمح النظام بتحديد ما إذا كان الدفع تم تحصيله من المطعم أو من شركة التوصيل.                                               |
| REQ-POS-189 | If the payment is collected by the restaurant, the order shall be processed using the normal POS payment methods.                               | إذا تم تحصيل الدفع من المطعم، يجب معالجة الطلب باستخدام طرق الدفع العادية في POS.                                                |
| REQ-POS-190 | If the payment is collected by the delivery company, the system shall not require cash, card, or bank payment from the cashier.                 | إذا تم تحصيل الدفع من شركة التوصيل، يجب ألا يطلب النظام من الكاشير اختيار دفع نقدي أو بطاقة أو بنك.                              |
| REQ-POS-191 | If the payment is collected by the delivery company, the system shall record the order amount as receivable from the selected delivery company. | إذا تم تحصيل الدفع من شركة التوصيل، يجب أن يسجل النظام مبلغ الطلب كذمة على شركة التوصيل المحددة.                                 |
| REQ-POS-192 | Each delivery company shall be linked to a separate receivable accounting account.                                                              | يجب ربط كل شركة توصيل بحساب ذمم محاسبي مستقل.                                                                                    |
| REQ-POS-193 | Talabat payments collected by Talabat shall be posted to a Talabat receivable account.                                                          | يجب ترحيل مدفوعات طلبات المحصلة من طلبات إلى حساب ذمم طلبات.                                                                     |
| REQ-POS-194 | Careem payments collected by Careem shall be posted to a Careem receivable account.                                                             | يجب ترحيل مدفوعات كريم المحصلة من كريم إلى حساب ذمم كريم.                                                                        |
| REQ-POS-195 | Ashyaai payments collected by Ashyaai shall be posted to an Ashyaai receivable account.                                                         | يجب ترحيل مدفوعات أشيائي المحصلة من أشيائي إلى حساب ذمم أشيائي.                                                                  |
| REQ-POS-196 | The cashier shall not be allowed to select or change the delivery company receivable account during POS payment.                                | لا يجوز للكاشير اختيار أو تغيير حساب ذمم شركة التوصيل أثناء دفع فاتورة POS.                                                      |
