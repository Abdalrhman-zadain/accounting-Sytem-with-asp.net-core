...
- Kitchen print-only flow: KOT is generated on `POST /pos/sales/:id/send-to-kitchen` and printed client-side; `KitchenOrder.hasUpdateNotification` is legacy and unused in the waiter-board flow
