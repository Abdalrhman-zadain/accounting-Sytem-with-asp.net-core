...
- POS runtime posting preferences are now persisted in `PosRuntimeSetting` as small key/value rows so the POS settings screen can store posting mode and COGS-posting behavior without requiring an environment-file edit
