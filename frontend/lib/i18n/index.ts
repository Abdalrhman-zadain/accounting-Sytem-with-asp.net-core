...
const enTranslations: Record<string, string> = {
  ...
  "nav.item.pos": "Restaurant POS",
  "nav.item.posMarket": "Market POS",
  ...
  "ledger.table.voucherName": "Voucher Name",
  "ledger.table.descriptionStatement": "Description / Statement",
  ...
  "master.tab.currencies": "Currencies",
  "master.tab.taxes": "Taxes",
...
Object.assign(enTranslations, {
  ...
  "salesReceivables.salesReps.field.marketLogin": "Market Login",
  "salesReceivables.salesReps.marketLogin.none": "No login",
  "salesReceivables.salesReps.marketLogin.title": "Create market login for {name}",
  "salesReceivables.salesReps.marketLogin.hint": "Creates a MARKET_REP user linked to this sales rep for field selling and receivables follow-up.",
  "salesReceivables.salesReps.marketLogin.successTitle": "Market login created",
  "salesReceivables.salesReps.marketLogin.successBody": "User {username} can now sign in to Market POS.",
  "salesReceivables.salesReps.marketLogin.roleBadge": "MARKET_REP",
  "salesReceivables.salesReps.marketLogin.field.username": "Username",
  "salesReceivables.salesReps.marketLogin.field.email": "Email",
  "salesReceivables.salesReps.marketLogin.field.displayName": "Display name",
  "salesReceivables.salesReps.marketLogin.field.password": "Password",
  "salesReceivables.salesReps.marketLogin.action.openCreate": "Create login",
  "salesReceivables.salesReps.marketLogin.action.create": "Create market login",
  "salesReceivables.salesReps.marketLogin.action.creating": "Creating...",
  "salesReceivables.salesReps.marketLogin.action.deactivate": "Deactivate login",
  "salesReceivables.salesReps.marketLogin.action.deactivateConfirm": "Deactivate market login {username}?",
  "salesReceivables.salesReps.marketLogin.error.session": "Sign in again to manage market logins.",
  "salesReceivables.salesReps.marketLogin.error.username": "Username is required.",
  "salesReceivables.salesReps.marketLogin.error.email": "Email is required.",
  "salesReceivables.salesReps.marketLogin.error.password": "Password must be at least 6 characters.",
  ...
  "salesReceivables.tab.repStatement": "Rep sales report",
  "salesReceivables.tab.marketStatement": "Market account statement",
...
"salesReceivables.creditNote.defaultDiscountLabel": "Post-sale discount 5%",
   "salesReceivables.creditNote.settlementLabel": "Customer settlement",
  ...
  "salesReceivables.creditNote.section.lines": "Credit Note Lines",
  "salesReceivables.creditNote.invoiceLine": "Invoice Line",
  "salesReceivables.creditNote.selectInvoiceLine": "Select invoice line",
  "salesReceivables.creditNote.returnedQuantity": "Returned Quantity",
  "salesReceivables.creditNote.returnToStock": "Return To Stock",
  "salesReceivables.creditNote.warehouse": "Warehouse",
  "salesReceivables.creditNote.selectWarehouse": "Select a warehouse",
  "salesReceivables.creditNote.itemCondition": "Item Condition",
  "salesReceivables.creditNote.originalPrice": "Original Price",
  "salesReceivables.creditNote.correctedPrice": "Corrected Price",
  "salesReceivables.creditNote.correctedTax": "Corrected Tax Amount",
  "salesReceivables.creditNote.originalTax": "Original Tax Amount",
  "salesReceivables.creditNote.settlementReason": "Settlement Reason",
  "salesReceivables.creditNote.addSettlementLine": "Add settlement line",
  "salesReceivables.creditNote.selectLinkedInvoice": "Select linked invoice",
  "salesReceivables.creditNote.selectedLine": "Selected line",
  "salesReceivables.creditNote.selectTypePlaceholder": "Select credit note type",
  ...
  "salesReceivables.validation.warehouseRequiredForInventory":
    "Warehouse is required for inventory item line {index}.",
  "salesReceivables.validation.insufficientWarehouseStock":
    "Line {index} ({itemCode}): warehouse {warehouse} has only {available} available, but {requested} was requested. Choose another warehouse, reduce quantity, or receive stock first.",
  "salesReceivables.stock.availableInWarehouse": "Available in this warehouse: {available}",
  "salesReceivables.stock.totalOnHand": "Total on hand across warehouses: {total}",
  "salesReceivables.stock.noWarehouseStock":
    "No stock in any warehouse. Receive goods first, or use a non-inventory item.",
...
Object.assign(enTranslations, {
  ...
  "pos.workspace.waiterOrders": "Order Tracking",
  "pos.workspace.delivery": "Delivery Board",
  ...
  "posMarket.title": "Market POS",
  "posMarket.description": "Retail and market checkout workspace — separate from restaurant POS.",
  "posMarket.workspace.register": "Register",
  "posMarket.workspace.sessions": "Shifts",
  "posMarket.scaffoldNote": "Market POS scaffold is active. Build new market flows here only.",
  "posMarket.apiStatus": "Market POS API",
  "posMarket.apiError": "Could not reach the market POS API.",
  "posMarket.catalogStatus": "Shared catalog (from ERP inventory)",
  "posMarket.catalogReady": "{count} market products ready",
  "posMarket.productGridTitle": "Products",
  "posMarket.catalogEmpty": "No market products found. Run: cd backend && npm run seed:market",
  "posMarket.catalogError": "Could not load the product catalog.",
  "posMarket.workspace.held": "Held Sales",
  "posMarket.workspace.review": "Accounting Review",
  "posMarket.workspace.returns": "Returns",
  "posMarket.workspace.reports": "Reports",
  "posMarket.workspace.printers": "Printers",
  "posMarket.workspace.settings": "Settings",
  "posMarket.session.openTitle": "MARKET POS OPEN SHIFT",
  "posMarket.session.loading": "Loading shift…",
  "posMarket.session.openDescription": "Choose terminal, warehouse, sales rep, and cash register to start selling.",
  "posMarket.session.staleTitle": "Close old shift first",
  "posMarket.session.staleDescription": "Shift {number} is still open from before rep-car stock was enabled. Close it, then open a new shift with a sales rep.",
  "posMarket.session.staleCloseAction": "Close old shift",
  "posMarket.session.openError": "Could not open the shift.",
  "posMarket.session.active": "Shift {number}",
  "posMarket.session.closed": "No open shift",
  "posMarket.session.closeBlocked": "Close blocked: drafts or held sales exist.",
  "posMarket.session.actualCashPlaceholder": "Actual counted cash",
  "posMarket.session.closingNotesPlaceholder": "Closing notes",
  "posMarket.session.confirmClose": "Confirm shift close",
  "posMarket.session.closeSuccess": "Shift closed successfully.",
  "posMarket.session.closeError": "Could not close the shift.",
  "posMarket.sessions.selectHint": "Select a session to view its report.",
  "posMarket.cart.title": "Cart",
  "posMarket.cart.linesCount": "{count} lines",
  "posMarket.cart.empty": "Cart is empty. Scan or tap a product to begin.",
  "posMarket.cart.total": "Total",
  "posMarket.cart.hold": "Hold",
  "posMarket.cart.clear": "Clear",
  "posMarket.cart.holdSuccess": "Sale held successfully.",
  "posMarket.cart.holdError": "Could not hold the sale.",
  "posMarket.destination.label": "Destination market",
  "posMarket.destination.searchPlaceholder": "Search market by name or code…",
  "posMarket.destination.notFound": "No market found.",
  "posMarket.destination.empty": "No market customers configured. Add customers in Sales Receivables or run seed:market.",
  "posMarket.destination.loadError": "Could not load destination markets. Refresh the page or contact support.",
  "posMarket.destination.tapToChoose": "Type to filter or pick a market from the list.",
  "posMarket.destination.clear": "Clear selected market",
  "posMarket.destination.requiredHint": "Select a destination market before completing the sale.",
  "posMarket.checkout.title": "Checkout",
  "posMarket.checkout.paymentMethod": "Payment method",
  "posMarket.checkout.amountTendered": "Amount tendered",
  "posMarket.checkout.pay": "Pay",
  ...
  "posMarket.checkout.creditHint":
    "Partial payment or pay-later is allowed when a destination market is selected.",
  "posMarket.checkout.payLater": "Pay later (credit)",
  "posMarket.checkout.insufficientPayment": "Tendered amount is below total and credit sale is disabled.",
  "posMarket.discount.repDiscount": "Rep discount",
  "posMarket.discount.lineDiscount": "Product discount",
  "posMarket.discount.invoiceDiscount": "Invoice discount",
  "posMarket.discount.addInvoiceDiscount": "Add invoice discount",
  "posMarket.discount.editDiscount": "Add discount",
  "posMarket.discount.fixed": "Fixed",
  "posMarket.discount.percent": "%",
  "posMarket.discount.aboveLimit": "Above discount limit ({limit}%)",
  "posMarket.discount.afterDiscount": "Total after discount",
  "posMarket.workspace.receivables": "Receivables",
  "posMarket.workspace.repLoads": "Rep car loads",
  "posMarket.workspace.repTransfers": "Rep car transfers",
  "posMarket.workspace.stockHub": "Stock hub",
  "posMarket.workspace.repStocktakes": "Rep car stocktake",
  "posMarket.workspace.myStock": "My car stock",
  "posMarket.repLoads.itemsError": "Could not load products. Try again.",
  "posMarket.repLoads.itemsLoading": "Loading products…",
  "posMarket.repLoads.itemsEmpty": "No market products found. Run market seed or add MKT-* items.",
  "posMarket.repLoads.listTitle": "Rep car loads",
  "posMarket.repLoads.newTitle": "New load draft",
  "posMarket.repLoads.noPermission": "Requires POS_MARKET_MANAGE_REP_LOADS permission.",
  "posMarket.repLoads.salesRep": "Sales rep",
  "posMarket.repLoads.warehouse": "Warehouse",
  "posMarket.repLoads.date": "Date",
  "posMarket.repLoads.notes": "Notes",
  "posMarket.repLoads.itemPlaceholder": "Product",
  "posMarket.repLoads.addLineButton": "+ Line",
  "posMarket.repLoads.saveDraft": "Save draft",
  "posMarket.repLoads.post": "Post",
  "posMarket.repLoads.cancel": "Cancel",
  "posMarket.repLoads.undo": "Undo load",
  "posMarket.repLoads.undoConfirm": "Return all loaded stock from the rep car back to the warehouse?",
  "posMarket.repLoads.undone": "Load reversed. Stock returned to warehouse.",
  "posMarket.repLoads.undoError": "Could not reverse the load.",
  "posMarket.repLoads.colOnCar": "On car",
  "posMarket.repLoads.reverseBlockedTitle": "Cannot undo this load",
  "posMarket.repLoads.reverseBlockedSales": "The rep already sold from the car after this load was posted.",
  "posMarket.repLoads.reverseBlockedShortfall": "{code}: loaded {loaded}, only {onCar} still on car.",
  "posMarket.repLoads.reversedAt": "Reversed on {date}",
  "posMarket.repLoads.draftCreated": "Load draft created.",
  "posMarket.repLoads.posted": "Load posted.",
  "posMarket.repLoads.cancelled": "Draft cancelled.",
  "posMarket.repLoads.saveError": "Could not save the load draft.",
  "posMarket.repLoads.postError": "Could not post the load.",
  "posMarket.repLoads.cancelError": "Could not cancel the draft.",
  "posMarket.repLoads.selectRepWarehouse": "Select a sales rep and warehouse.",
  "posMarket.repLoads.addLine": "Add at least one line.",
  "posMarket.repLoads.warehouseStockLoading": "Loading warehouse stock…",
  "posMarket.repLoads.colProduct": "Product",
  "posMarket.repLoads.colQuantity": "Qty",
  "posMarket.repLoads.colUnit": "Unit",
  "posMarket.repLoads.colAvailable": "Available",
  "posMarket.repLoads.warehouseOnHand": "Available: {qty}",
  "posMarket.repLoads.lineShortage": "Short {shortage}",
  "posMarket.repLoads.setToAvailable": "Set to available",
  "posMarket.repLoads.stockSummaryTitle": "{count} product(s) exceed warehouse stock",
  "posMarket.repLoads.stockSummaryLine": "{code}: only {onHand} available",
  "posMarket.repLoads.saveBlockedStock": "{count} line(s) exceed available stock. Fix the highlighted rows.",
  "posMarket.repLoads.exceedsWarehouseStock": "{code}: only {onHand} available",
  "posMarket.repTransfers.listTitle": "Rep car transfers",
  "posMarket.repTransfers.newTitle": "New transfer draft",
  "posMarket.repTransfers.noPermission": "Administrators only — sales reps cannot transfer stock between cars.",
  "posMarket.repTransfers.fromRep": "From rep",
  "posMarket.repTransfers.toRep": "To rep",
  "posMarket.repTransfers.repPlaceholder": "Select rep",
  "posMarket.repTransfers.date": "Date",
  "posMarket.repTransfers.notes": "Notes",
  "posMarket.repTransfers.itemPlaceholder": "Product",
  "posMarket.repTransfers.addLineButton": "+ Line",
  "posMarket.repTransfers.saveDraft": "Save draft",
  "posMarket.repTransfers.post": "Post",
  "posMarket.repTransfers.cancel": "Cancel",
  "posMarket.repTransfers.undo": "Undo transfer",
  "posMarket.repTransfers.undoConfirm": "Move all transferred stock back from the destination rep to the source rep?",
  "posMarket.repTransfers.undone": "Transfer reversed.",
  "posMarket.repTransfers.undoError": "Could not reverse the transfer.",
  "posMarket.repTransfers.colOnCar": "On car",
  "posMarket.repTransfers.reverseBlockedTitle": "Cannot undo this transfer",
  "posMarket.repTransfers.reverseBlockedSales": "The destination rep already sold from the car after this transfer was posted.",
  "posMarket.repTransfers.reverseBlockedShortfall": "{code}: transferred {transferred}, only {onCar} still on destination car.",
  "posMarket.repTransfers.reversedAt": "Reversed on {date}",
  "posMarket.repTransfers.draftCreated": "Transfer draft created.",
  "posMarket.repTransfers.posted": "Transfer posted.",
  "posMarket.repTransfers.cancelled": "Draft cancelled.",
  "posMarket.repTransfers.saveError": "Could not save the transfer draft.",
  "posMarket.repTransfers.postError": "Could not post the transfer.",
  "posMarket.repTransfers.cancelError": "Could not cancel the draft.",
  "posMarket.repTransfers.selectReps": "Select source and destination reps.",
  "posMarket.repTransfers.sameRepError": "Source and destination reps must be different.",
  "posMarket.repTransfers.addLine": "Add at least one line.",
  "posMarket.repTransfers.selectFromRep": "Select a source rep to load on-car stock.",
  "posMarket.repTransfers.stockLoading": "Loading rep car stock…",
  "posMarket.repTransfers.stockEmpty": "No stock on the selected rep car.",
  "posMarket.repTransfers.colProduct": "Product",
  "posMarket.repTransfers.colQuantity": "Qty",
  "posMarket.repTransfers.colUnit": "Unit",
  "posMarket.repTransfers.lineShortage": "Short {shortage}",
  "posMarket.repTransfers.stockSummaryTitle": "{count} product(s) exceed source rep on-hand",
  "posMarket.repTransfers.stockSummaryLine": "{code}: only {onHand} on car",
  "posMarket.repTransfers.saveBlockedStock": "{count} line(s) exceed source on-hand. Fix the highlighted rows.",
  "posMarket.stockHub.noPermission": "Requires POS_MARKET_MANAGE_REP_LOADS permission.",
  "posMarket.stockHub.overviewTitle": "Network stock overview",
  "posMarket.stockHub.search": "Search products",
  "posMarket.stockHub.searchPlaceholder": "Code or name",
  "posMarket.stockHub.hideZero": "Hide zero balances",
  "posMarket.stockHub.loading": "Loading stock overview…",
  "posMarket.stockHub.loadError": "Could not load stock overview.",
  "posMarket.stockHub.empty": "No market stock found.",
  "posMarket.stockHub.colProduct": "Product",
  "posMarket.stockHub.colQuantity": "Qty",
  "posMarket.stockHub.colUnit": "Unit",
  "posMarket.stockHub.transferTitle": "Move stock",
  "posMarket.stockHub.fromLocation": "From",
  "posMarket.stockHub.toLocation": "To",
  "posMarket.stockHub.locationPlaceholder": "Select location",
  "posMarket.stockHub.locationWarehouse": "Warehouse",
  "posMarket.stockHub.locationRep": "Rep",
  "posMarket.stockHub.warehousesGroup": "Warehouses",
  "posMarket.stockHub.repsGroup": "Sales reps",
  "posMarket.stockHub.date": "Date",
  "posMarket.stockHub.notes": "Notes",
  "posMarket.stockHub.itemPlaceholder": "Product",
  "posMarket.stockHub.addLineButton": "+ Line",
  "posMarket.stockHub.available": "Available at source: {qty}",
  "posMarket.stockHub.postTransfer": "Create and post transfer",
  "posMarket.stockHub.posting": "Posting…",
  "posMarket.stockHub.transferPosted": "Stock moved successfully.",
  "posMarket.stockHub.transferError": "Could not move stock.",
  "posMarket.stockHub.selectLocations": "Select source and destination locations.",
  "posMarket.stockHub.sameLocationError": "Source and destination must be different.",
  "posMarket.stockHub.addLine": "Add at least one line with quantity.",
  "posMarket.stockHub.repTransferAdminOnly": "Rep-to-rep transfers require administrator access.",
  "posMarket.stockHub.kindLoad": "Warehouse → rep (rep car load)",
  "posMarket.stockHub.kindUnload": "Rep → warehouse (rep car unload)",
  "posMarket.stockHub.kindRepTransfer": "Rep → rep (admin transfer)",
  "posMarket.stockHub.kindWhTransfer": "Warehouse → warehouse (ERP transfer)",
  "posMarket.stockHub.kindUnknown": "Select valid source and destination",
  "posMarket.stockOverview.openHint": "View all warehouse and rep car balances in a full-screen grid.",
  "posMarket.stockOverview.openButton": "Open overview",
  "posMarket.stockOverview.summary": "{locations} locations · {items} products with stock",
  "posMarket.stockOverview.subtitle": "All warehouses and sales rep cars in one grid",
  "posMarket.stockOverview.backToHub": "← Back to stock hub",
  "posMarket.myStock.movement.TRANSFER_IN": "Transfer in",
  "posMarket.myStock.movement.TRANSFER_OUT": "Transfer out",
  "posMarket.myStock.movement.LOAD_IN": "Load in",
  "posMarket.myStock.movement.LOAD_OUT": "Load out",
  "posMarket.myStock.movement.SALE_OUT": "Sale",
  "posMarket.myStock.movement.STOCKTAKE_IN": "Stocktake in",
  "posMarket.myStock.movement.STOCKTAKE_OUT": "Stocktake out",
  "posMarket.myStock.repOnly": "This screen is for market sales reps only.",
  "posMarket.myStock.noRepLink": "Your user account is not linked to a sales representative.",
  "posMarket.myStock.skuCount": "Products on car",
  "posMarket.myStock.totalQty": "Total quantity",
  "posMarket.myStock.totalValue": "Total value",
  "posMarket.myStock.onCarTitle": "Stock on car",
  "posMarket.myStock.recentMovements": "Recent movements",
  "posMarket.myStock.loading": "Loading…",
  "posMarket.myStock.error": "Could not load car stock.",
  "posMarket.myStock.empty": "No stock on your car yet. Ask admin to post a rep load.",
  "posMarket.myStock.noMovements": "No movements yet.",
  "posMarket.myStock.colCode": "Code",
  "posMarket.myStock.colName": "Product",
  "posMarket.myStock.colOnHand": "On hand",
  "posMarket.myStock.colUnit": "Unit",
  "posMarket.myStock.colValue": "Value",
  "posMarket.myStock.colDate": "Date",
  "posMarket.myStock.colType": "Type",
  "posMarket.myStock.colProduct": "Product",
  "posMarket.myStock.colReference": "Reference",
  "posMarket.myStock.colQtyIn": "In",
  "posMarket.myStock.colQtyOut": "Out",
  "posMarket.stocktake.noPermission": "Requires POS_MARKET_REP_STOCKTAKE permission.",
  "posMarket.stocktake.historyTitle": "Stocktake history",
  "posMarket.stocktake.newTitle": "New stocktake",
  "posMarket.stocktake.salesRep": "Sales rep",
  "posMarket.stocktake.date": "Date",
  "posMarket.stocktake.reason": "Reason",
  "posMarket.stocktake.loadBalances": "Load system balances",
  "posMarket.stocktake.showVarianceOnly": "Show only items with variance",
  "posMarket.stocktake.catalogError": "Could not load rep car balances.",
  "posMarket.stocktake.noLines": "No items with stock on this rep car.",
  "posMarket.stocktake.colCode": "Code",
  "posMarket.stocktake.colName": "Product",
  "posMarket.stocktake.colSystem": "System",
  "posMarket.stocktake.colCounted": "Counted",
  "posMarket.stocktake.colVariance": "Variance",
  "posMarket.stocktake.colUnit": "Unit",
  "posMarket.stocktake.colValue": "Variance value",
  "posMarket.stocktake.saveDraft": "Save draft",
  "posMarket.stocktake.post": "Post",
  "posMarket.stocktake.draftCreated": "Stocktake draft created.",
  "posMarket.stocktake.posted": "Stocktake posted.",
  "posMarket.stocktake.varianceLineCount": "{count} lines with variance",
  "posMarket.stocktake.totalVariance": "Total variance qty {qty}, value {amount}",
  "posMarket.receivables.title": "Market receivables",
  "posMarket.receivables.subtitle": "Outstanding balances for destination markets.",
  "posMarket.receivables.totalOutstanding": "Total outstanding",
  "posMarket.receivables.customerCount": "Markets with balance",
  "posMarket.receivables.searchPlaceholder": "Search market name or code…",
  "posMarket.receivables.salesRepFilter": "Sales rep",
  "posMarket.receivables.allReps": "All reps",
  "posMarket.receivables.market": "Market",
  "posMarket.receivables.rep": "Sales rep",
  "posMarket.receivables.balance": "Outstanding",
  "posMarket.receivables.invoices": "Open invoices",
  "posMarket.receivables.collect": "Collect payment",
  "posMarket.receivables.noRows": "No open receivables found.",
  "posMarket.receivables.collectTitle": "Collect from market",
  "posMarket.receivables.amount": "Receipt amount",
  "posMarket.receivables.bankAccount": "Bank / cash account",
  "posMarket.receivables.receiptDate": "Receipt date",
  "posMarket.receivables.allocate": "Allocate to invoice",
  "posMarket.receivables.collectSuccess": "Payment recorded successfully.",
  "posMarket.receivables.collectError": "Could not record the payment.",
  "posMarket.receivables.loadError": "Could not load receivables.",
  "posMarket.receivables.detail.view": "Details",
  "posMarket.receivables.detail.title": "Market account",
  "posMarket.receivables.detail.back": "Back to receivables",
  "posMarket.receivables.detail.totalDelivered": "Total delivered",
  "posMarket.receivables.detail.totalPaid": "Total collected",
  ...
  "posMarket.receivables.detail.loadError": "Could not load market account.",
  "posMarket.receivables.detail.collectHint": "Outstanding balance: {balance}. Payment is applied to the customer account (oldest deliveries first).",
  "posMarket.receivables.detail.collectHintSimple": "Payment is applied to the customer account total (oldest deliveries first).",
  "posMarket.statement.title": "Market account statements",
  "posMarket.statement.subtitle": "Delivered, collected, and remaining balance for each destination market.",
  "posMarket.statement.detailTitle": "Market account statement",
  "posMarket.statement.delivered": "Delivered",
  "posMarket.statement.collected": "Collected",
  "posMarket.statement.remaining": "Remaining",
  "posMarket.statement.print": "Print statement",
  "posMarket.statement.view": "View statement",
  "posMarket.statement.balanceOnly": "Markets with balance only",
  "posMarket.statement.noRows": "No destination markets found.",
  "posMarket.statement.printError": "Could not print the account statement.",
  "posMarket.statement.back": "Back to account statements",
  "posMarket.statement.periodTitle": "Statement period",
  "posMarket.statement.periodHint": "Choose from/to dates, then print an A4 statement or export PDF.",
  "posMarket.statement.fromDate": "From date",
  "posMarket.statement.toDate": "To date",
  "posMarket.statement.printA4": "Print A4 statement",
  "posMarket.statement.exportPdf": "PDF",
  "posMarket.statement.dateRangeRequired": "Select both from and to dates.",
  "posMarket.statement.invalidDateRange": "From date must be on or before to date.",
  "posMarket.statement.openingBalance": "Opening balance",
  "posMarket.repStatement.title": "Rep sales report",
  "posMarket.repStatement.subtitle": "Sales invoices and returns for the selected rep; returns appear as negative amounts.",
  "posMarket.repStatement.repFilter": "Sales rep",
  "posMarket.repStatement.selectRep": "Select a sales rep",
  "posMarket.repStatement.repRequired": "Select a sales rep.",
  "posMarket.repStatement.marketFilter": "Market (optional)",
  "posMarket.repStatement.allMarkets": "All markets",
  "posMarket.repStatement.documentTypeFilter": "Document type",
  "posMarket.repStatement.documentTypeBoth": "Sales and returns",
  "posMarket.repStatement.documentTypeSales": "Sales invoices",
  "posMarket.repStatement.documentTypeReturns": "Sales returns",
  "posMarket.repStatement.paymentTypeFilter": "Payment type",
  "posMarket.repStatement.paymentTypeBoth": "Cash and credit",
  "posMarket.repStatement.paymentTypeCash": "Cash",
  "posMarket.repStatement.paymentTypeCredit": "Credit",
  "posMarket.repStatement.fromDate": "From date",
  "posMarket.repStatement.toDate": "To date",
  "posMarket.repStatement.periodHint": "Choose filters and dates, then preview totals or print the A4 sales report.",
  "posMarket.repStatement.preview": "Preview totals",
  "posMarket.repStatement.printA4": "Print A4 report",
  "posMarket.repStatement.exportPdf": "PDF",
  "posMarket.repStatement.dateRangeRequired": "Select both from and to dates.",
  "posMarket.repStatement.invalidDateRange": "From date must be on or before to date.",
  "posMarket.repStatement.printError": "Could not print the rep sales report.",
  "posMarket.repStatement.printSuccess": "Rep sales report sent to print.",
  "posMarket.repStatement.documentCount": "Document count",
  "posMarket.repStatement.totalAmount": "Total amount",
  "posMarket.workspace.repStatement": "Rep sales report",
  "posMarket.workspace.accountStatements": "Account statements",
  "posMarket.held.drafts": "Draft sales",
  "posMarket.held.heldSales": "Held sales",
  "posMarket.held.noDrafts": "No draft sales saved yet.",
  "posMarket.held.noSession": "Open a shift on the register to view held sales.",
  "posMarket.held.linesCount": "{count} lines",
  "posMarket.review.sales": "sales",
  "posMarket.review.approveSuccess": "Sale approved.",
  "posMarket.review.approveError": "Could not approve the sale.",
  "posMarket.review.rejectSuccess": "Sale rejected.",
  "posMarket.review.rejectError": "Could not reject the sale.",
  "posMarket.review.reverseSuccess": "Sale reversed.",
  "posMarket.review.reverseError": "Could not reverse the sale.",
  "posMarket.review.sessionApproveSuccess": "Session approved.",
  "posMarket.review.sessionApproveError": "Could not approve the session.",
  "posMarket.review.sessionRejectSuccess": "Session rejected.",
  "posMarket.review.sessionRejectError": "Could not reject the session.",
  "posMarket.returns.recent": "Recent returns",
  "posMarket.returns.empty": "No returns recorded yet.",
  "posMarket.returns.preview": "{count} line(s) · {amount}",
  "posMarket.returns.submit": "Create return",
  "posMarket.returns.processing": "Processing…",
  "posMarket.returns.success": "Return created successfully.",
  "posMarket.returns.error": "Could not create the return.",
  "posMarket.returns.noPaymentAccount": "Original sale has no payment account.",
  "posMarket.returns.soldQty": "Sold: {qty}",
  "posMarket.settings.description": "Payment method to GL account mappings for market POS checkout.",
  "posMarket.settings.paymentMappings": "Payment account mappings",
  "posMarket.settings.cashAccount": "Cash",
  "posMarket.settings.cardAccount": "Card",
  "posMarket.settings.cliqAccount": "CliQ",
  "posMarket.settings.walletAccount": "Wallet",
  "posMarket.settings.bankTransferAccount": "Bank transfer",
  "posMarket.settings.selectAccount": "Select account",
  "posMarket.settings.searchAccount": "Type account name…",
  "posMarket.settings.save": "Save mappings",
  "posMarket.settings.saveSuccess": "Settings saved.",
  "posMarket.settings.saveError": "Could not save settings.",
  "posMarket.printers.description": "Configure the receipt printer for this market register computer.",
  "posMarket.printers.refresh": "Refresh printers",
  "posMarket.printers.selectReceipt": "Select receipt printer",
  "posMarket.printers.autoPrintReceipt": "Auto-print receipt on payment",
  "posMarket.printers.useBrowserPrint": "Use browser print fallback",
  "posMarket.printers.save": "Save printer settings",
  "posMarket.printers.test": "Test receipt printer",
  "posMarket.printers.testing": "Testing…",
  "posMarket.printers.saveSuccess": "Printer settings saved.",
  "posMarket.printers.testSuccess": "Test print sent.",
  "posMarket.printers.fallbackUsed": "Opened browser print fallback.",
  "posMarket.printers.bridgeUnavailable": "QZ Tray is not connected; browser print fallback will be used.",
  ...
  "pos.sales.description":
    "This first POS increment adds the sidebar structure and a sales-terminal screen only. It uses live items, warehouses, and payment methods from the current ERP so the UI is ready for the next operational workflow step.",
  "pos.sales.metric.catalog": "Catalog",
  "pos.sales.metric.catalogHint": "active sellable items",
  "pos.sales.metric.warehouses": "Warehouses",
  "pos.sales.metric.warehouseNotSelected": "No warehouse selected yet",
  "pos.sales.metric.paymentMethods": "Payment Methods",
  "pos.sales.metric.paymentNotSelected": "No payment account selected yet",
  "pos.sales.metric.paymentHint": "configured active payment accounts",
  "pos.sales.metric.heldSales": "Held Sales",
  "pos.sales.metric.heldHint": "draft sales ready to resume",
  "pos.sales.searchLabel": "Search",
  "pos.sales.searchPlaceholder": "Search barcode, item code, item name, or category...",
  "pos.sales.warehouseLabel": "Warehouse",
  "pos.sales.paymentLabel": "Payment Method",
  "pos.sales.paymentSectionTitle": "Payments",
  "pos.sales.paymentAmount": "Amount",
  "pos.sales.paymentReference": "Reference / Auth Code",
  "pos.sales.removePayment": "Remove payment line",
  "pos.sales.addPayment": "Add payment",
  "pos.sales.categoryAll": "All",
  "pos.sales.emptyTitle": "No matching items",
  "pos.sales.emptyDescription": "Try another search term or switch the active category filter.",
  "pos.sales.loadErrorTitle": "Unable to load items",
  "pos.sales.loadErrorDescription":
    "The POS catalog could not be loaded from the inventory API. Refresh the page or review the inventory item query settings.",
  "pos.sales.onHand": "On Hand",
  "pos.sales.serviceItem": "Service Item",
  "pos.sales.cartTitle": "Current Sale",
  "pos.sales.cartSubtitle": "{count} lines in cart",
  "pos.sales.clearCart": "Clear",
  "pos.sales.cartEmptyTitle": "Cart is empty",
  "pos.sales.cartEmptyDescription": "Click a product card to add it directly to the current sale.",
  "pos.sales.totalSubtotal": "Subtotal",
  "pos.sales.totalDiscount": "Discounts",
  "pos.sales.totalTax": "Tax",
  "pos.sales.totalGrand": "Grand Total",
  "pos.sales.cashTenderedLabel": "Cash Tendered",
  "pos.sales.totalPaid": "Paid",
  "pos.sales.totalChange": "Change",
  "pos.sales.amountDue": "Amount Due",
  "pos.sales.accountLabel": "Account",
  "pos.sales.tenderedAmountLabel": "Tendered Amount",
  "pos.sales.referencePlaceholder": "Card slip / CliQ ref",
  "pos.sales.tenderedLabel": "Tendered",
  "pos.sales.changeLabel": "Change",
  "pos.sales.amountDueLabel": "Amount Due",
  "pos.sales.printReceiptLabel": "Print receipt after completion",
  "pos.sales.completingAction": "Completing...",
  "pos.sales.completeAction": "Complete Sale",
  "pos.sales.lineTotal": "Line Total",
  "pos.sales.unitCost": "Unit Cost",
  "pos.sales.totalCost": "Total Cost",
  "pos.sales.holdAction": "Hold",
  "pos.sales.voidAction": "Void",
  "pos.sales.removeLine": "Remove",
  "pos.sales.invoiceDiscountType": "Invoice Discount Type",
  "pos.sales.invoiceDiscountValue": "Invoice Discount Value",
  "pos.sales.discountFixed": "Fixed Amount",
  "pos.sales.discountPercent": "Percentage",
  "pos.sales.selectWarehouseLine": "Select line warehouse",
  "pos.sales.sessionCard": "Session",
  "pos.sales.sessionTerminal": "Terminal #01",
  "pos.sales.sessionWarehouse": "Warehouse",
  "pos.sales.sessionPayment": "Default payment",
  "pos.sales.sessionStatus": "Status",
  "pos.sales.sessionOpen": "Open",
  "pos.sales.sessionClosed": "Closed",
  "pos.sales.closeSessionAction": "Mark session as closed",
  "pos.sales.openSessionAction": "Open Session",
  "pos.sales.openingCash": "Opening Cash",
  "pos.sales.expectedCash": "Expected Cash",
  "pos.sales.quickNote": "Quick Note",
  "pos.sales.quickNoteDefault":
    "POS sales now save sessions, held invoices, completed receipts, and review-ready accounting drafts through the backend workflow.",
  ...
  "pos.sales.heldLabel": "Held Sale",
  "pos.sales.resumeHeld": "Resume",
  "pos.sales.heldSummary": "{count} lines saved in this held sale",
  "pos.sales.alert.uiOnly": "Sale completion UI is ready, but posting and inventory execution are not implemented yet.",
  "pos.sales.alert.emptyCart": "Add at least one item before completing the sale.",
  "pos.sales.alert.insufficientPayment": "The paid amount is lower than the invoice total.",
  "pos.sales.alert.sessionClosed": "Open the session before using the sales terminal.",
  "pos.sales.alert.sessionOpened": "The POS session is now open and ready for selling.",
  "pos.sales.alert.sessionMarkedClosed":
    "The session has been closed and the shift report is ready.",
  "pos.sales.alert.sessionMarkedOpen": "The session is now marked open in the UI preview.",
  "pos.sales.alert.savedToHold": "The current sale has been saved as a held invoice.",
  "pos.sales.alert.resumedHeldSale": "The held sale has been restored into the current cart.",
  "pos.sales.alert.voidedDraft": "The current draft cart has been cleared.",
  "pos.sales.alert.paymentRequired": "Add at least one payment method before completing the sale.",
  "pos.sales.alert.warehouseRequired": "Every inventory line needs a warehouse before completion.",
  "pos.sales.alert.accountMappingRequired":
    "The required sales or inventory accounts are missing for {item}.",
  "pos.sales.alert.stockExceeded": "The requested quantity for {item} exceeds the available stock.",
  "pos.sales.alert.saleCompleted": "The sale has been completed and the receipt is ready to print.",
  "pos.sales.alert.noReceiptYet": "There is no completed receipt to print yet.",
  "pos.sales.alert.printBlocked": "The receipt window was blocked by the browser.",
  "pos.sales.alert.noBarcodeMatch": "No item matched the entered barcode or code.",
  "pos.sales.barcodeSearch": "Barcode / Search",
  "pos.sales.barcodePlaceholder": "Scan barcode or search by name",
  "pos.sales.allCategories": "All",
  "pos.sales.orderSummary": "Order Summary",
  "pos.sales.itemsCount": "{count} item(s)",

  "pos.sessions.noOpen": "No open POS session right now.",
  "pos.sessions.activeDescription": "Open session {sessionNumber} at {terminalName}",
  "pos.sessions.recent": "Recent Sessions",
  "pos.sessions.expected": "Expected",
  "pos.sessions.actual": "Actual",
  "pos.sessions.difference": "Difference",
  "pos.sessions.invoices": "Invoices",
  "pos.sessions.returnsHint": "{count} returns",
  "pos.sessions.branch": "Branch",
  "pos.sessions.warehouse": "Warehouse",
  "pos.sessions.cashAccount": "Cash Account",
  "pos.sessions.openingCash": "Opening Cash",
  "pos.sessions.cashSales": "Cash Sales",
  "pos.sessions.cashRefunds": "Cash Refunds",
  "pos.sessions.cardSales": "Card Sales",
  "pos.sessions.cliqSales": "CliQ Sales",
  "pos.sessions.walletSales": "Wallet Sales",
  "pos.sessions.bankTransferSales": "Bank Transfer",
  "pos.sessions.discounts": "Discounts",
  "pos.sessions.tax": "Tax",
  "pos.sessions.totalSales": "Total Sales",
  "pos.sessions.openedAt": "Opened",
  "pos.sessions.closedAt": "Closed",
  "pos.sessions.terminalLabel": "Terminal",
  "pos.sessions.cashierLabel": "Cashier",
  "pos.sessions.cashRegisterLabel": "Cash Register",
  "pos.sessions.terminalNumberLabel": "Terminal Number",
  "pos.sessions.openShiftAction": "Open Shift",
  "pos.sessions.closeShiftAction": "Close Shift",
  "pos.sessions.openingAction": "Opening...",
  "pos.sessions.closingAction": "Closing...",

  "pos.held.description": "Resume or void held POS sales without affecting inventory, cash, or accounting.",
  "pos.held.legend": "Badges show sale type: draft, held, table reservation (حجز), open table order, and order channel.",
  "pos.held.kind.DRAFT": "Draft",
  "pos.held.kind.HELD": "Held",
  "pos.held.kind.RESERVATION": "Reservation",
  "pos.held.kind.TABLE_ORDER": "Table order",
  "pos.held.reservationWindow": "Reserved {from} – {to}",
  "pos.held.tableLabel": "Table {number}",
  ...
  "pos.review.reject": "Reject",
  "pos.review.reverse": "Reverse",
  "pos.review.sessionWarehouse": "Session: {session} · Warehouse: {warehouse}",
  "pos.review.subtotal": "Subtotal",
  "pos.review.discount": "Discount",
  "pos.review.tax": "Tax",
  "pos.review.change": "Change",
  "pos.review.linesTitle": "Lines",
  "pos.review.paymentsTitle": "Payments",
  "pos.review.empty": "No POS sales are waiting for accountant review right now.",
  "pos.review.submittedSessions": "Submitted sessions",
  ...
  "pos.review.reviewDifference": "Review difference",
  "pos.review.reviewAction": "Review",
  "pos.review.accountingStatusPendingReview": "Pending review",
  "pos.review.accountingStatusPosted": "Posted",
  "pos.review.accountingStatusRejected": "Rejected",
  "pos.review.accountingStatusOpen": "Open",
  "pos.review.accountingStatusClosed": "Closed",
  "pos.review.openCloseTime": "Open / close time",
  "pos.review.sessionNotes": "Session notes",
  "pos.review.invoicesListTitle": "Completed sales and returns in this session",
  "pos.review.noInvoices": "No invoices were recorded in this session.",
  "pos.review.headerReference": "Reference",
  "pos.review.headerDate": "Date",
  "pos.review.headerCustomer": "Customer",
  "pos.review.headerOrderType": "Order type",
  "pos.review.headerPaymentMethod": "Payment method",
  "pos.review.headerTotal": "Total",
  "pos.review.headerReviewStatus": "Review status",
  "pos.review.cashPaymentMethod": "Cash",
  "pos.review.returnBadge": "Return",
  "pos.review.viewDetails": "View details",
  "pos.review.paymentBreakdownTitle": "Captured payment methods",
  "pos.review.noPaymentDetails": "No payment details.",
  "pos.review.loadingCashDetails": "Loading cash-count details...",
  "pos.review.noInventoryImpact": "No inventory impact for the current session.",
  "pos.review.journalHeaderAccount": "Account",
  "pos.review.journalHeaderDebit": "Debit",
  "pos.review.journalHeaderCredit": "Credit",
  "pos.review.differenceModalTitle": "Accept cash difference",
  "pos.review.expectedAmount": "Expected amount (cash)",
  "pos.review.actualAmount": "Actual counted amount",
  "pos.review.shortage": "Shortage",
  "pos.review.overage": "Overage",
  "pos.review.decision": "Decision",
  "pos.review.acceptDifference": "Accept difference",
  "pos.review.differenceToleranceWarning": "Cash difference is above the allowed tolerance ({tolerance} JOD) and requires manager approval.",
  "pos.review.reasonNotes": "Reason / notes",
  "pos.review.reasonPlaceholder": "Enter the decision details and the reason for acceptance or rejection...",
  "pos.review.confirmDecision": "Confirm decision",
  "pos.review.soldItems": "Sold items",
  "pos.review.unitPrice": "Unit price",
  "pos.review.paymentDetails": "Payment details",
  "pos.review.amount": "Amount",
  "pos.review.finalTotal": "Final total",
  "pos.review.walkInCustomer": "Walk-in customer",
  "pos.review.allBranches": "All branches",
  "pos.review.allCashiers": "All cashiers",
  "pos.review.allStatuses": "All statuses",
  "pos.review.paymentMethodCash": "Cash",
  "pos.review.paymentMethodCard": "Card",
  "pos.review.paymentMethodDelivery": "Delivery companies",
  "pos.review.tabOverview": "Overview",
  "pos.review.tabCash": "Cash Count",
  "pos.review.tabInventory": "Inventory Impact",
  "pos.review.tabJournal": "Journal Entry Preview",
  "pos.review.openingCash": "Opening cash",
  "pos.review.cashSales": "Cash sales",
  "pos.review.cashRefunds": "Cash refunds",
  "pos.review.expectedCash": "Expected cash",
  "pos.review.actualCash": "Actual cash counted",
  "pos.review.cashDifference": "Cash difference",
  "pos.review.inventoryImpact": "Inventory impact",
  "pos.review.headerSale": "Sale",
  "pos.review.headerItem": "Item",
  "pos.review.headerQuantity": "Quantity",
  "pos.review.headerWarehouse": "Warehouse",
  "pos.review.noJournals": "No draft journal entries linked to the selected session.",
  "pos.review.noTable": "No table",
  "pos.review.tableLabel": "Table {table}",
  "pos.review.directCounter": "Direct / Counter",
  "pos.review.receipt": "Receipt",
  "pos.review.correctOrderType": "Correct order type",
  "pos.review.correctPaymentMethod": "Correct payment method",
  "pos.review.driver": "Driver",
  "pos.review.statusPending": "Pending",
  "pos.review.statusPreparing": "Preparing",
  "pos.review.statusReady": "Ready",
  "pos.review.statusOut": "Out",
  "pos.review.statusDelivered": "Delivered",
  "pos.review.statusCancelled": "Cancelled",
  "pos.review.deliveryService": "Delivery / Service",
  "pos.review.correctOrderTypeModal": "Correct Order Type",
  "pos.review.correctPaymentMethodModal": "Correct Payment Method",
  "pos.review.invoiceNumber": "Invoice number",
  "pos.review.invoiceTotal": "Invoice total",
  "pos.review.currentPaymentMethod": "Current payment method",
  "pos.review.newPaymentMethod": "New payment method",
  "pos.review.paymentReference": "Reference number",
  "pos.review.paymentMethodDeliveryCompany": "Delivery company",
  "pos.orderType.DINE_IN": "Dine-In",
  "pos.orderType.TAKEAWAY": "Takeaway",
  "pos.orderType.DELIVERY": "Delivery",
  "pos.orderType.PICKUP": "Pickup",
  "pos.review.selectTable": "Select table",
  "pos.review.selectDeliveryCompany": "Select delivery company",
  "pos.review.selectDriver": "Select driver",
  "pos.review.serviceCharge": "Service charge",
  "pos.review.deliveryFee": "Delivery fee",
  "pos.review.correctionReason": "Reason",
  "pos.review.saveCorrection": "Save correction",
  ...
  "pos.returns.originalSaleLabel": "Original sale",
  "pos.returns.selectSalePlaceholder": "Select a completed POS sale",
  "pos.returns.receiptLabel": "Receipt",
  "pos.returns.sessionLabel": "Session",
  "pos.returns.warehouseLabel": "Warehouse",
  "pos.returns.invoiceTotalLabel": "Invoice total",
  "pos.returns.reasonLabel": "Return reason",
  "pos.returns.reasonPlaceholder": "Damaged item, customer cancellation, pricing correction...",
  "pos.returns.soldAt": "Sold {quantity} at {price} each",
  "pos.returns.lineTotalLabel": "Line total",
  "pos.returns.returnQtyLabel": "Return qty",
  "pos.returns.refundMethodsTitle": "Refund methods",
  "pos.returns.addRefundAction": "Add refund",
  "pos.returns.method.CASH": "Cash",
  "pos.returns.method.CARD": "Card",
  "pos.returns.method.CLIQ": "CliQ",
  "pos.returns.method.BANK_TRANSFER": "Bank Transfer",
  "pos.returns.method.WALLET": "Wallet",
  "pos.returns.method.STORE_CREDIT": "Store Credit",
  "pos.returns.referencePlaceholder": "Reference",
  "pos.returns.returnedLines": "Returned lines",
  "pos.returns.expectedRefund": "Expected refund",
  "pos.returns.allocatedRefund": "Allocated refund",
  "pos.returns.returnsMetric": "Returns",
  "pos.returns.returnsHint": "Operational returns created from completed POS sales.",
  "pos.returns.refundedMetric": "Refunded",
  "pos.returns.refundedHint": "Total refund amount recorded across POS returns.",
  "pos.returns.pendingMetric": "Pending",
  "pos.returns.pendingHint": "Returns waiting for accounting review.",
  "pos.returns.selectSaleHelp": "Choose a completed POS sale to start a return.",

  "pos.reports.description": "Payment mix, cashier performance, branch totals, pending review exposure, stock impact, and tax summary for POS activity.",
  "pos.reports.pendingReviewLabel": "Pending Review",
  "pos.reports.pendingReviewHint": "Completed POS sales waiting for accounting.",
  "pos.reports.paymentMixLabel": "Payment Mix",
  "pos.reports.paymentMixHint": "Distinct payment methods used in POS sales.",
  "pos.reports.cashiersLabel": "Cashiers",
  "pos.reports.cashiersHint": "Cashiers with completed POS sales in the current report.",
  "pos.reports.branchesLabel": "Branches",
  "pos.reports.branchesHint": "Branches represented in POS reporting.",
  "pos.reports.salesByPaymentTitle": "Sales by payment method",
  "pos.reports.paymentValue": "{amount} · {count} invoices",
  "pos.reports.salesByCashierTitle": "Sales by cashier",
  "pos.reports.salesByBranchTitle": "Sales by branch",
  "pos.reports.taxSummaryTitle": "Tax summary",
  "pos.reports.taxValue": "{netTax} net tax · {returnTax} returns",
  "pos.reports.salesByItemTitle": "Sales by item",
  "pos.reports.header.item": "Item",
  "pos.reports.header.qty": "Qty",
  "pos.reports.header.sales": "Sales",
  "pos.reports.header.tax": "Tax",
  "pos.reports.inventoryImpactTitle": "Inventory impact",
  "pos.reports.header.reference": "Reference",
  ...
  "pos.settings.allowCloseWithDrafts": "Allow close with drafts",
  "pos.settings.negativeStock": "Negative stock",
  "pos.settings.cashierDiscountLimit": "Cashier discount limit",
  "pos.settings.enabled": "Enabled",
  "pos.settings.disabled": "Disabled",
  "pos.settings.allowed": "Allowed",
  "pos.settings.blocked": "Blocked",
  "pos.settings.roleActionsTitle": "Role-based POS actions",
  "pos.settings.header.action": "Action",
  "pos.settings.header.allowed": "Allowed",
  "pos.settings.yes": "Yes",
  "pos.settings.no": "No",
  "pos.settings.loadError": "POS runtime settings could not be loaded.",

  "pos.reservation.preorder.button": "Pre-order products",
  "pos.reservation.preorder.buttonResume": "View / edit pre-order",
  "pos.reservation.preorder.summary": "Pre-order",
  "pos.reservation.preorder.items": "items",
  "pos.reservation.preorder.total": "Total",
  "pos.reservation.preorder.opening": "Opening pre-order…",
  "pos.reservation.preorder.banner": "Pre-order mode — table not occupied yet",
  "pos.reservation.preorder.bannerSub": "Items will be held. Table stays Available until the reservation window.",

  "pos.kitchen.title": "Kitchen Display",
  "pos.kitchen.subtitle": "Orders sent to the kitchen — move each ticket until it is done",
  "pos.kitchen.activeCount": "Active tickets",
  "pos.kitchen.readyCount": "Ready to serve",
  "pos.kitchen.refresh": "Refresh",
  "pos.kitchen.searchPlaceholder": "Search order, table, waiter…",
  "pos.kitchen.showDone": "Show completed orders",
  "pos.kitchen.autoRefresh": "Auto-refresh every 3s",
  "pos.kitchen.filterUpdates": "Updates only",
  "pos.kitchen.kitchenMode": "Kitchen mode",
  "pos.kitchen.exitKitchenMode": "Exit kitchen mode",
  "pos.kitchen.fullScreen": "Full screen",
  "pos.kitchen.exitFullScreen": "Exit full screen",
  "pos.kitchen.orderDetails": "Order details",
  "pos.kitchen.statusHistory": "Status",
  "pos.kitchen.startPreparing": "Start preparing",
  "pos.kitchen.markReady": "Mark ready",
  "pos.kitchen.markServed": "Mark served",
  "pos.kitchen.printTicket": "Print ticket",
  "pos.kitchen.dismissNotification": "Dismiss update",
  "pos.kitchen.moreItems": "+{count} more items",
  "pos.kitchen.closeDrawer": "Close",
  "pos.kitchen.late": "Late",
  "pos.kitchen.rushFilter": "Rush only",
  "pos.kitchen.cashierUpdated": "Cashier updated",
  "pos.kitchen.placedAt": "Placed",
  "pos.kitchen.updatedAt": "Last update",
  "pos.kitchen.emptyColumn": "No orders in this stage",
  "pos.kitchen.column.new": "New",
  "pos.kitchen.column.preparing": "Preparing",
  "pos.kitchen.column.ready": "Ready",
  "pos.kitchen.column.done": "Done",
  "pos.waiterOrders.title": "Order Tracking",
  "pos.waiterOrders.subtitle": "Dine-in orders — waiting, received, departed",
  "pos.waiterOrders.searchPlaceholder": "Search table, order, waiter…",
  "pos.waiterOrders.emptyColumn": "No orders in this stage",
  "pos.waiterOrders.column.waiting": "Waiting",
  "pos.waiterOrders.column.received": "Received",
  "pos.waiterOrders.column.departed": "Departed",
  "pos.delivery.title": "Delivery Board",
  "pos.delivery.subtitle": "Live delivery orders — assign drivers and move each order until delivered",
  "pos.delivery.activeCount": "Active orders",
  "pos.delivery.outCount": "Out for delivery",
  "pos.delivery.refresh": "Refresh",
  "pos.delivery.searchPlaceholder": "Search reference, address, customer, driver…",
  "pos.delivery.showDone": "Show delivered & cancelled",
  "pos.delivery.autoRefresh": "Auto-refresh every 15s",
  "pos.delivery.emptyColumn": "No orders in this stage",
  "pos.delivery.assignDriver": "Assign driver",
  "pos.delivery.cancel": "Cancel order",
  "pos.delivery.column.pending": "Pending",
  "pos.delivery.column.preparing": "Preparing",
  "pos.delivery.column.ready": "Ready to dispatch",
  "pos.delivery.column.out": "Out for delivery",
  "pos.delivery.column.delivered": "Delivered",
  "pos.delivery.column.cancelled": "Cancelled",
  "pos.delivery.accountingSubtitle": "Delivery receivables and settlement follow-up",
  "pos.delivery.receivablesTitle": "Delivery receivables",
  "pos.delivery.receivablesSubtitle": "Outstanding balances by company",
  "pos.delivery.outstanding": "Outstanding",
  "pos.delivery.settled": "Settled",
  "pos.delivery.total": "Total",
  "pos.delivery.activate": "Activate",
  "pos.delivery.deactivate": "Deactivate",
  "pos.delivery.settlementTitle": "Delivery settlement",
  "pos.delivery.settlementSubtitle": "Preview unsettled orders, then confirm one settlement posting.",
  "pos.delivery.selectCompany": "Select company",
  "pos.delivery.previewSettlement": "Load Unsettled Orders",
  "pos.delivery.selectBankAccount": "Select bank/cash account",
  "pos.delivery.statementReference": "Delivery Company Statement Reference",
  "pos.delivery.statement": "Delivery Company Statement",
  "pos.delivery.commission": "Commission",
  "pos.delivery.serviceFees": "Service fees",
  "pos.delivery.refunds": "Refunds",
  "pos.delivery.adjustments": "Adjustments",
  "pos.delivery.differenceReason": "Difference reason / reason code",
  "pos.delivery.selectDifferenceAccount": "Select difference account",
  "pos.delivery.differenceNotes": "Difference notes",
  "pos.delivery.gross": "Gross Orders according to System",
  "pos.delivery.difference": "Settlement Difference",
  "pos.delivery.netReceived": "Actual Amount Transferred to Bank",
  "pos.delivery.netExpected": "Net Expected Amount",
  "pos.delivery.notes": "Notes",
  "pos.delivery.confirmSettlement": "Confirm settlement",
  "pos.delivery.ordersInPreview": "Orders in preview",
  "pos.delivery.settlementsHistoryTitle": "Settlements history",
  "pos.delivery.reverse": "Reverse",
  "pos.delivery.settlementStatus.PENDING": "Pending",
  "pos.delivery.settlementStatus.PARTIALLY_SETTLED": "Partially Settled",
  "pos.delivery.settlementStatus.SETTLED": "Settled",
  "pos.delivery.settlementStatus.DIFFERENCE": "Difference",
...
Object.assign(enTranslations, {
  ...
  "reporting.trialBalance.total.openingDebit": "Opening debit",
  "reporting.trialBalance.total.openingCredit": "Opening credit",
  "reporting.trialBalance.total.periodDebit": "Period debit",
  "reporting.trialBalance.total.periodCredit": "Period credit",
  ...
  "reporting.trialBalance.row.total": "Total",
  "reporting.trialBalance.row.difference": "Difference",
  ...
  "reporting.column.openingDebit": "Opening debit",
  "reporting.column.openingCredit": "Opening credit",
  "reporting.column.closingBalance": "Closing balance",
  "reporting.column.closingDebit": "Closing debit",
  "reporting.column.closingCredit": "Closing credit",
  "reporting.column.netMovement": "Net movement",
  "reporting.column.periodDebit": "Period debit",
  "reporting.column.periodCredit": "Period credit",
  ...
  "reporting.column.voucherName": "Voucher Name",
  "reporting.column.description": "Description",
  "reporting.column.descriptionStatement": "Description / Statement",
  ...
  "reporting.summary.movementBalance": "Movement Balance",
  "reporting.summary.total": "Total",
  "reporting.summary.finalBalance": "Final Balance",
...
Object.assign(enTranslations, {
  ...
  "inventory.import.importing": "Importing...",
  "inventory.import.importValid": "Import {count} valid rows",
  "inventory.import.resultTitle": "Import finished",
  "inventory.import.resultCreated": "Created: {count}",
  "inventory.import.resultSkipped": "Skipped: {count}",
  "inventory.import.resultFailed": "Failed: {count}",
  "inventory.import.column.name": "Name",
  "inventory.import.column.code": "Code",
  "inventory.import.column.status": "Status",
  "inventory.import.column.message": "Message",
  "inventory.import.status.valid": "Valid",
  "inventory.import.status.error": "Error",
  "inventory.import.status.skip": "Skipped",
  "inventory.import.error.emptyWorkbook": "The workbook has no sheets.",
  "inventory.import.error.noRows": "The selected sheet is empty.",
  "inventory.import.error.noDataRows": "No product rows were found after the header row.",
  "inventory.import.error.parseFailed": "Could not read the Excel file.",
  "inventory.import.error.previewFailed": "Preview failed.",
  "inventory.import.error.importFailed": "Import failed.",
