...
Object.assign(enTranslations, {
  ...
  "posMarket.repLoads.warehouseOnHand": "In warehouse: {qty}",
  "posMarket.repLoads.lineOverStock": "Requested {demand}, only {onHand} available",
  "posMarket.repLoads.exceedsWarehouseStock":
    "Item {code} does not have enough stock in the warehouse (available {onHand}, requested {demand}).",
