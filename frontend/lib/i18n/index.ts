...
Object.assign(enTranslations, {
  ...
  "pos.sales.cartSubtitle": "{count} lines in the cart",
  "pos.sales.clearCart": "Clear",
  "pos.sales.cartEmptyTitle": "The cart is still empty",
  "pos.sales.cartEmptyDescription": "Choose products from the catalog on the left to start the sale flow.",
  ...
  "pos.placeholder.sessions":
    "Shifts will live here later, including opening cash, cashier/warehouse assignment, and shift-close cash balancing.",
  "pos.placeholder.held":
    "Held invoices will be added here later so cashiers can resume suspended sales during the same session.",
  "pos.placeholder.review":
    "Accountant review will land here later for pending-review POS invoices, posting approval, and rejection workflow.",
  "pos.placeholder.returns":
    "Returns and refund handling will be implemented here in a later POS increment.",
  "pos.placeholder.reports":
    "POS session, cashier, payment-method, tax, and inventory-impact reports will be added here later.",
  "pos.placeholder.settings":
    "POS settings will be implemented here later for numbering, permissions, account mapping, and terminal defaults.",
