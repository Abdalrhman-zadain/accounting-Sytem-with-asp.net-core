          ...
          <div className="space-y-5">
            ...
            <section className="rounded-2xl border border-slate-200 bg-white p-4 shadow-sm sm:p-5 transition-all duration-200 hover:shadow-md">
              ...
              <div className="grid gap-4 sm:grid-cols-2 md:grid-cols-4">
                <div>
                  <Field id="transfer-reference" label={isArabic ? "الرقم المرجعي" : "Reference"} labelAlign={isArabic ? "end" : "start"} labelClassName={labelClassName}>
                    <Input
              ...
              <div className="mt-4">
                <Field id="transfer-description" label={isArabic ? "الوصف العام" : "General Description"} labelAlign={isArabic ? "end" : "start"} labelClassName={labelClassName}>
                  <Textarea
